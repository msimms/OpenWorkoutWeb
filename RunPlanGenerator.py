...
class RunPlanGenerator(object):
    ...
    def gen_speed_run(self, short_interval_run_pace, speed_run_pace, easy_run_pace, rep_relief):
        ...
        interval_workouts = [ [6,100], [6,200], [6,300], [5,600], [4,800], [3,1000], [4,1000], [5,1000], [2,1600], [4,1600] ]
        ...
        if selected_interval_workout[1] < 1000:
        ...
        selected_interval_workout[0] = selected_interval_workout[0] - rep_relief
        ...
        interval_run_workout.add_warmup(10 * 60)
        interval_run_workout.add_interval(selected_interval_workout[0], selected_interval_workout[1], selected_pace, selected_interval_workout[1] * 2, easy_run_pace)
        interval_run_workout.add_cooldown(10 * 60)

        # Tally up the easy and hard distance so we can keep the weekly plan in check.
        self.easy_distance_amount += ((selected_interval_workout[0] - 1) * (selected_interval_workout[1] * 2))
        self.hard_distance_amount += (selected_interval_workout[0] * selected_interval_workout[1])
