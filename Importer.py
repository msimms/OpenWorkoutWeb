            ...
            for track in gpx.tracks:
                ...
                for segment in track.segments:
                    for point in segment.points:
                        ...
                        self.location_writer.create_location(device_str, activity_id_str, dt_unix, point.latitude, point.longitude, point.elevation)
                ...
                for lap in activity.Lap:
                    for track in lap.Track:
                        for point in track.Trackpoint:
                            ...
                            dt_unix = calendar.timegm(dt_obj)
                            self.location_writer.create_location(device_str, activity_id_str, dt_unix, point.Position.LatitudeDegrees, point.Position.LongitudeDegrees, point.AltitudeMeters)
            return True
        return False
